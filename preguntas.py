...
def pregunta_01():
    ...
    #df = pd.read_csv('C:/Users/Dellphoto/Documents/Universidad/Analitica predictiva/maquinas-de-vectores-de-soporte-para-clasificacion-german-JuanesLopez/german.csv')
